...
const AddRates = () => {
  ...
  const [rateLabelText, setRateLabelText] = useState("Risk Rate")
  ...
  const changeRateTypeText = (type) => {
    console.log(type)
    if(type === 1){
      setRateLabelText("Risk Rate")
    }
    else{
      setRateLabelText("Revaluation Rate")
    }
  }
            ...
            <div  className="col-md-12 grid-margin stretch-card">
              <div  className="card">
                  ...
                  <div  className="card-body">
                    <h4  className="card-title">Add Risk Rates</h4>
                    ...
                    <div  className="row">
                      ...
                      <div  className="col-md-4">
                        <div  className="form-group">
                          <label >{rateLabelText}</label>
                          <input type="text"  className="form-control" id="usdriskRate" placeholder=" USD Rate" {...register("usdRiskRate", { required: true })} />
                    ...
                    <div  className="row">
                      ...
                      <div  className="col-md-4">
                        <div  className="form-group">
                          <input type="text"  className="form-control" id="zwlriskRate" placeholder="ZWL Rate" {...register("zwlRiskRate", { required: true })} />
                    ...
                    <div  className="row">
                      ...
                      <div  className="col-md-4">
                        <div  className="form-group">
                          <input type="text"  className="form-control" id="zarrevalRate" placeholder="ZAR Rate" {...register("zarRiskRate", { required: true })} />
                    ...
                    <div  className="row">
                      ...
                      <div  className="col-md-4">
                        <div  className="form-group">
                          <input type="text"  className="form-control" id="eurriskRate" placeholder="EUR Rate" {...register("eurRiskRate", { required: true })} />
